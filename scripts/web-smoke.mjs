...
if (!advanced.includes('capturePanelScroll(host.querySelector(\'.plan-panel-body\'))') || !advanced.includes('capturePanelScroll(host.querySelector(\'.orchestration-nodes\'))')) throw new Error('Orchestration panels must preserve reading anchors while refreshing')
