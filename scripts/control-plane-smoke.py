...
def main() -> None:
    with tempfile.TemporaryDirectory(prefix="custom-opencode-control-plane-") as temp:
        ...
        expect({"action": "read", "resources": ["../outside.txt"]}, effect="ask", risk="R3", workspace=str(workspace))
        ...
        expect({"action": "shell", "resources": ["cat ../../outside.txt"]}, effect="ask", risk="R3", workspace=str(workspace))
        ...
        expect({"action": "edit", "resources": ["../outside.txt"]}, effect="ask", risk="R2", workspace=str(workspace))
