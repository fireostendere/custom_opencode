...
SERVICE_ENV=(
  ...
  DND_QWEN_TIMEOUT_S DND_QWEN_AUTOSTART DND_ROUTER_TIMEOUT_MS DND_TELEMETRY_FILE
  ...
  OPENCODE_DND_NARRATOR_MODEL OPENCODE_DND_COMPLEX_MODEL OPENCODE_DND_EXCEPTIONAL_MODEL
  OPENCODE_DND_PLANNER_MODEL OPENCODE_DND_MEMORY_MODEL OPENCODE_DND_READER_MODEL
